...
% masses.
function cluster_stats = cluster_peak(labelled_spatiotemporal_clusters, group_maps, vertex_level_threshold)
    ...
    for cluster_i = cluster_ids'
        ...
        cluster_values = group_maps(this_cluster_location);
        cluster_stats(cluster_i) = max(cluster_values(:));
    end
end
